          ...
          <div className="relative">
            ...
            <button
              ...
              className={[
                ...
                loading ? 'cursor-not-allowed opacity-60 text-slate-300' : 'text-slate-200 hover:text-white',
              ].join(' ')}
            >
          ...
          <div className="flex justify-end">
            <button
              ...
              className={[
                ...
                canSubmit ? 'bg-slate-600 hover:bg-slate-500 cursor-pointer' : 'bg-slate-700 cursor-not-allowed opacity-60',
              ].join(' ')}
            >
